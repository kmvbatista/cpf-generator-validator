...
class Cpf_generator:
    ...
    def get_final_digits(self, first_nine_digits):
        first_validation_digit = self.digit_validator.get_validation_digit(
            self.get_string_from_list(first_nine_digits))
        cpf_digits = [*first_nine_digits, first_validation_digit]
        second_validation_digit = self.digit_validator.get_validation_digit(
            self.get_string_from_list(cpf_digits), get_second_digit=True)
